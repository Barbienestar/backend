...
CREATE ALIAS IF NOT EXISTS get_hospital_stock_averages FOR "com.itesm.infrastructure.persistence.repository.H2Procedures.getHospitalStockAverages";
CREATE ALIAS IF NOT EXISTS get_hospital_stock_report FOR "com.itesm.infrastructure.persistence.repository.H2Procedures.getHospitalStockReport";
