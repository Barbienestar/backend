...
public class ReportResource {
    ...
    @RequestBody(
        ...
        content = @Content(
            ...
            examples = @ExampleObject(
                name = "sample",
                value = "{\"medicine_id\": 1, \"hospital_id\": 2, \"description\": \"No hay stock desde hace 3 días.\", \"image_url\": \"https://storage.example.com/reports/abc.jpg\"}"
            )
        )
    )
    @APIResponse(
        ...
        content = @Content(
            ...
            examples = @ExampleObject(
                name = "created",
                value = "{\"id\": 10, \"medicine_name\": \"Paracetamol\", \"hospital_name\": \"Hospital Civil\", \"status_id\": 1, \"description\": \"No hay stock desde hace 3 días.\", \"created_at\": \"2024-06-01T10:00:00\"}"
            )
        )
    )
    ...
    @Operation(
        ...
        description = "Returns all reports submitted by the authenticated user. Any authenticated role is accepted."
    )
    @APIResponse(
        responseCode = "200",
        ...
        content = @Content(
            ...
            examples = @ExampleObject(
                name = "sample",
                value = "[{\"id\": 10, \"medicine_name\": \"Paracetamol\", \"hospital_name\": \"Hospital Civil\", \"status\": \"Pendiente\", \"description\": \"Sin stock\", \"image_url\": \"https://...\", \"created_at\": \"2024-06-01T10:00:00\", \"updated_at\": \"2024-06-01T10:00:00\"}]"
            )
        )
    )
    @APIResponse(responseCode = "401", description = "Missing or invalid Bearer token")
    ...
    @APIResponse(
        ...
        content = @Content(
            ...
            examples = @ExampleObject(
                name = "sample",
                value = "{\"items\": [{\"id\": 10, \"description\": \"Sin stock\", \"image_url\": \"https://...\", \"user_full_name\": \"Ana García\", \"medicine_name\": \"Paracetamol\", \"medicine_presentation\": \"20 tablets\", \"medicine_dosage_form\": \"Tablet\", \"hospital_name\": \"Hospital Civil\", \"created_at\": \"2024-06-01T10:00:00\"}], \"page\": 0, \"page_size\": 10, \"total_items\": 1, \"total_pages\": 1}"
            )
        )
    )
    @APIResponse(responseCode = "401", description = "Missing or invalid Bearer token")
    ...
    @Operation(
        ...
        description = "Updates the status of a report. Requires admin role."
    )
